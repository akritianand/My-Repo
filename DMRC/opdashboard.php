<?php
  session_start();
  if (!isset($_SESSION ['emptype']) || $_SESSION ['emptype'] != 'Operations') {
        ...
        <div class="content">
            ...
            <div class="col-md-8">
                        <div class="card ">
                            ...
                            ?>
                            <div class="header">
                                <h4 class="title">Place Job Requests</h4>
                            </div>
                            <div class="content" text>
                                 <form action="opjobsubmit.php" method="POST">
                                  <p id="line">
                                  ...
                                  <p>
                                    ...
                                    <div>
                                    <textarea name="description" rows="6" cols="70" placeholder="Enter Text Here..."></textarea>
