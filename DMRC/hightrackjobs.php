<?php
	session_start();
    if (!isset($_SESSION ['emptype']) || $_SESSION['empdesg'] != 'DGM' || $_SESSION['empdesg'] != 'AGM') {
            ...
            <div class="row">
                <div class="col-md-12" style="padding-right: 0em;">
                    <div class="card">
                        ...
                        <table id="responsecontainer7" style='width:100%' class="scroll table table-responsive table-hover"><thead><tr><th style="width: 200px;">Ticket ID</th><th>System</th><th>Equipment</th><th>Opened by</th><th>Opened at</th><th>Station</th><th>Status</th><th>Closed by</th><th>Closed at</th></tr></thead></table>
                        </div> </div>
                    </div>
                </div>
            </div>
