<?php
	session_start();
    if (!isset($_SESSION ['emptype']) || $_SESSION['empdesg'] != 'AM') {
...
<head>
    ...
    <script type="text/javascript" src="assets/js/am.js"></script>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Track Jobs </a>
                </div>
                ...
                <div class="card">
                	...
                	<div class="content">
                    	<form id="place1" method="POST">
                    		...
                    		<div class="col-md-1">
                    		<button type="submit" class="btn btn-info btn-fill">Find</button>
                    		</div>
                    		</div>
                    	</form>
                        ...
                        <form id="place5" method="POST">
                            <div class="row">
                                <div class="col-md-3">
                                    <input type="text" id="mainstaff" name="mainstaff" placeholder="Maintenance Staff" class="form-control">
                                </div>
                                <div class="col-md-1">
                                    <button type="submit" class="btn btn-info btn-fill">Find</button>
                                </div>
                        ...
                        <button id="jobtoday" class="btn-fill btn btn-info">View all job requests today</button>
                        <button id="openjob" class="btn-fill btn btn-info">View open job requests</button>
                	</div>
               </div>
           </div>
       </div>
            ...
            <div class="row">
                <div class="col-md-12" style="padding-right: 0em;">
                    <div class="card">
                        ...
                        <table id="responsecontainer1" style='width:100%' class="scroll table table-responsive table-hover"><thead><tr><th style="width: 200px;">Ticket ID</th><th>System</th><th>Equipment</th><th>Opened by</th><th>Opened at</th><th>Station</th><th>Status</th><th>Closed by</th><th>Closed at</th></tr></thead></table>
                        </div> </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12" style="padding-right: 0em;">
                    <div class="card">
                        ...
                        <table id="responsecontainer2" style='width:100%' class="scroll table table-responsive table-hover"><thead><tr><th style="width: 200px;">Ticket ID</th><th>System</th><th>Equipment</th><th>Opened by</th><th>Opened at</th><th>Station</th><th>Status</th><th>Closed by</th><th>Closed at</th></tr></thead></table>
                        </div> </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12" style="padding-right: 0em;">
                    <div class="card">
                        ...
                        <table id="responsecontainer3" style='width:100%' class="scroll table table-responsive table-hover"><thead><tr><th style="width: 200px;">Ticket ID</th><th>System</th><th>Equipment</th><th>Opened by</th><th>Opened at</th><th>Station</th><th>Status</th><th>Closed by</th><th>Closed at</th></tr></thead></table>
                        </div> </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12" style="padding-right: 0em;">
                    <div class="card">
                        ...
                        <table id="responsecontainer4" style='width:100%' class="scroll table table-responsive table-hover"><thead><tr><th style="width: 200px;">Ticket ID</th><th>System</th><th>Equipment</th><th>Opened by</th><th>Opened at</th><th>Station</th><th>Status</th><th>Closed by</th><th>Closed at</th></tr></thead></table>
                        </div> </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12" style="padding-right: 0em;">
                    <div class="card">
                        ...
                        <table id="responsecontainer5" style='width:100%' class="scroll table table-responsive table-hover"><thead><tr><th style="width: 200px;">Ticket ID</th><th>System</th><th>Equipment</th><th>Opened by</th><th>Opened at</th><th>Station</th><th>Status</th><th>Closed by</th><th>Closed at</th></tr></thead></table>
                        </div> </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12" style="padding-right: 0em;">
                    <div class="card">
                        ...
                        <table id="responsecontainer6" style='width:100%' class="scroll table table-responsive table-hover"><thead><tr><th style="width: 200px;">Ticket ID</th><th>System</th><th>Equipment</th><th>Opened by</th><th>Opened at</th><th>Station</th><th>Status</th><th>Closed by</th><th>Closed at</th></tr></thead></table>
                        </div> </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12" style="padding-right: 0em;">
                    <div class="card">
                        ...
                        <table id="responsecontainer7"  class="scroll table table-responsive table-hover"><thead><tr><th style="width: 200px;">Ticket ID</th><th>System</th><th>Equipment</th><th>Opened by</th><th>Opened at</th><th>Station</th><th>Status</th><th>Closed by</th><th>Closed at</th></tr></thead></table>
                        </div> </div>
                    </div>
                </div>
            </div>
