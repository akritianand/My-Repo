<?php
    ...
    if (isset($_POST['month']) && $_POST['month']) {
        ...
        $sql1 = "SELECT Ticket.ticket_open_close FROM Ticket, Station WHERE MONTH(Ticket.ticket_open_datetime) = $month AND Station.station_id = Ticket.ticket_station_id AND Station.station_line = $line AND Station.station_section = '$sec'";
            ...
            while($row = $result->fetch_assoc()){
                if ($row['ticket_open_close'] == 'Open') {
                    $sql = "SELECT distinct Ticket.ticket_id, Emp1.emp_id as e1, Emp1.emp_firstname as openfname, Emp1.emp_lastname as openlname,  System.system_name, Equipments.equip_name, Ticket.ticket_open_empid, Ticket.ticket_close_empid, Ticket.ticket_open_close, Ticket.ticket_open_datetime, Ticket.ticket_close_datetime, Station.station_name   FROM Ticket, Station, System, Equipments, Employee as Emp1 WHERE 
                        MONTH(Ticket.ticket_open_datetime) = $month AND Ticket.ticket_open_close = 'Open' AND Station.station_id = Ticket.ticket_station_id AND Ticket.ticket_system_id = System.system_id AND Equipments.equip_id = Ticket.ticket_equip_id AND Ticket.ticket_open_empid = Emp1.emp_id AND Station.station_line = $line AND Station.station_section = '$sec'" ;
                }
                else {
    ...
    if (isset($_POST['sdate']) && $_POST['sdate'] && isset($_POST['fdate']) && $_POST['fdate']) {
        ...
        $sql1 = "SELECT Ticket.ticket_open_close FROM Ticket, Station WHERE DATE(Ticket.ticket_open_datetime) BETWEEN '$sdate' AND '$fdate' AND Station.station_id = Ticket.ticket_station_id AND Station.station_line = $line AND Station.station_section = '$sec'";
        $result = $link->query($sql1);
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()){
                if ($row['ticket_open_close'] == 'Open') {
                    $sql = "SELECT distinct Ticket.ticket_id, Emp1.emp_id as e1, Emp1.emp_firstname as openfname, Emp1.emp_lastname as openlname,  System.system_name, Equipments.equip_name, Ticket.ticket_open_empid, Ticket.ticket_close_empid, Ticket.ticket_open_close, Ticket.ticket_open_datetime, Ticket.ticket_close_datetime, Station.station_name   FROM Ticket, Station, System, Equipments, Employee as Emp1 WHERE 
                        DATE(Ticket.ticket_open_datetime) BETWEEN '$sdate' AND '$fdate' AND Ticket.ticket_open_close = 'Open' AND Station.station_id = Ticket.ticket_station_id AND Ticket.ticket_system_id = System.system_id AND Equipments.equip_id = Ticket.ticket_equip_id AND Ticket.ticket_open_empid = Emp1.emp_id AND Station.station_line = $line AND Station.station_section = '$sec'" ;
                }
                else {
                    $sql2 = "SELECT distinct Ticket.ticket_id, Emp1.emp_id as e1, Emp2.emp_id as e2, Emp1.emp_firstname as openfname, Emp1.emp_lastname as openlname, Emp2.emp_firstname as closefname, Emp2.emp_lastname as closelname, System.system_name, Equipments.equip_name, Ticket.ticket_open_empid, Ticket.ticket_close_empid, Ticket.ticket_open_close, Ticket.ticket_open_datetime, Ticket.ticket_close_datetime, Station.station_name FROM Ticket, Station, System, Equipments, Employee as Emp1, Employee as Emp2 WHERE 
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()){
                if ($row['ticket_open_close'] == 'Open') {
                    ...
                    $sql2 = "SELECT distinct Ticket.ticket_id, Emp1.emp_id as e1, Emp2.emp_id as e2, Emp1.emp_firstname as openfname, Emp1.emp_lastname as openlname, Emp2.emp_firstname as closefname, Emp2.emp_lastname as closelname, System.system_name, Equipments.equip_name, Ticket.ticket_open_empid, Ticket.ticket_close_empid, Ticket.ticket_open_close, Ticket.ticket_open_datetime, Ticket.ticket_close_datetime, Station.station_name FROM Ticket, Station, System, Equipments, Employee as Emp1, Employee as Emp2 WHERE 
                        Ticket.ticket_id = $ticketid AND (Ticket.ticket_open_close = 'Close' OR Ticket.ticket_open_close = 'Pending') AND Station.station_id = Ticket.ticket_station_id AND Ticket.ticket_system_id = System.system_id AND Equipments.equip_id = Ticket.ticket_equip_id AND Ticket.ticket_open_empid = Emp1.emp_id AND Ticket.ticket_close_empid = Emp2.emp_id" ;
                }
            }
        }
    }
    ...
    if (isset($_POST['station']) && $_POST['station']) {
        $sql1 = "SELECT Ticket.ticket_open_close FROM Ticket, Station WHERE Station.station_name = '$station'";
        $result = $link->query($sql1);
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()){
                if ($row['ticket_open_close'] == 'Open') {
    ...
    switch ($_GET['type']) {
        case "openjob":
            $sql = "SELECT distinct Ticket.ticket_id, Emp1.emp_id as e1, Emp1.emp_firstname as openfname, Emp1.emp_lastname as openlname,  System.system_name, Equipments.equip_name, Ticket.ticket_open_empid, Ticket.ticket_close_empid, Ticket.ticket_open_close, Ticket.ticket_open_datetime, Ticket.ticket_close_datetime, Station.station_name   FROM Ticket, Station, System, Equipments, Employee as Emp1 WHERE 
                Ticket.ticket_open_close = 'Open' AND Station.station_id = Ticket.ticket_station_id AND Ticket.ticket_system_id = System.system_id AND Equipments.equip_id = Ticket.ticket_equip_id AND Ticket.ticket_open_empid = Emp1.emp_id AND  Station.station_line = $line AND Station.station_section = '$sec'";
            break;

        case "jobtoday":
            $sql1 = "SELECT Ticket.ticket_open_close FROM Ticket, Station WHERE DATE(Ticket.ticket_open_datetime) = curdate() AND Station.station_id = Ticket.ticket_station_id AND Station.station_line = $line AND Station.station_section = '$sec'";
            $result = $link->query($sql1); 
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()){
                    if ($row['ticket_open_close'] == 'Open') {
                        $sql = "SELECT distinct Ticket.ticket_id, Emp1.emp_id as e1, Emp1.emp_firstname as openfname, Emp1.emp_lastname as openlname,  System.system_name, Equipments.equip_name, Ticket.ticket_open_empid, Ticket.ticket_close_empid, Ticket.ticket_open_close, Ticket.ticket_open_datetime, Ticket.ticket_close_datetime, Station.station_name   FROM Ticket, Station, System, Equipments, Employee as Emp1 WHERE 
                            DATE(ticket_open_datetime) = curdate() AND Ticket.ticket_open_close = 'Open' AND Station.station_id = Ticket.ticket_station_id AND Ticket.ticket_system_id = System.system_id AND Equipments.equip_id = Ticket.ticket_equip_id AND Ticket.ticket_open_empid = Emp1.emp_id AND Station.station_line = $line AND Station.station_section = '$sec'" ;
                    }
                    else {
                        $sql2 = "SELECT distinct Ticket.ticket_id, Emp1.emp_id as e1, Emp2.emp_id as e2, Emp1.emp_firstname as openfname, Emp1.emp_lastname as openlname, Emp2.emp_firstname as closefname, Emp2.emp_lastname as closelname, System.system_name, Equipments.equip_name, Ticket.ticket_open_empid, Ticket.ticket_close_empid, Ticket.ticket_open_close, Ticket.ticket_open_datetime, Ticket.ticket_close_datetime, Station.station_name FROM Ticket, Station, System, Equipments, Employee as Emp1, Employee as Emp2 WHERE 
